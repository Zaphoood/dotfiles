...
beautiful.init("/home/mathis/.config/awesome/themes/default/theme.lua")
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "j",
        function ()
            -- Swap the behavior of j and k - I think it makes more sense this way
            -- awful.client.focus.byidx( 1)
            awful.client.focus.byidx( -1)
        end,
    ...
    -- TODO: This overrides previously defined shortcut
